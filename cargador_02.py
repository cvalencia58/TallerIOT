...
DEVICE_ID = "cargador-py-02" 
PRIMARY_KEY = "pk0bEzmrN0gktgJU+GDbebDv+432F0uuz6JZw4L/x84="
        ...
        while True:
            ...
            payload = {
                ...
                "Ubicacion": {
                    ...
                    "lat": 7.1310 + random.uniform(-0.001, 0.001),
                    "lon": -73.1245 + random.uniform(-0.001, 0.001)
                }
            }
